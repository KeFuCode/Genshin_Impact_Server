...
伪随机：计算机的世界是二维世界，没有时间维度。人类生存的世界是三维世界，多出时间维度。多次投掷 10 枚硬币，在人类的世界中，结果完全无法预测，因为时间只能不停向前流逝，不能倒退回某个时间点。计算机世界并不是这样，在计算机世界中，以某一个时刻/时间点作为生成随机数的种子，如果种子相同，生成的随机数顺序也相同。用人类世界来类比，就是时光倒流，把投掷硬币的那个人反复来回到他投掷硬币前的那个点。这样，每次硬币生成的投掷结果都是相同的。